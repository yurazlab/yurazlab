...
export const inProgress: InProgressProject[] = [
  {
    ...
    title: "Селлерапия — нейро-помощник для селлеров",
    description:
      "Когда новости о складах, новые условия WB и неопределённость мешают спокойно соображать, здесь можно выговориться, отделить факты от опасений и понять ближайший шаг. Без продажи услуг внутри разговора.",
    task: "Помочь селлерам сохранять ясность и способность принимать решения в период высокой бизнес-неопределённости",
    stack: ["Next.js", "TypeScript", "Python", "MAX", "Cloud.ru AI", "PostgreSQL"],
