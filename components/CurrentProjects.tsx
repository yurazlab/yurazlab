...
const completed = [
  ...
  },
  {
    ...
    description:
      "Telegram-бот для транскрибации аудио и видео с таймкодами и структурированным конспектом. Начинался как внутренний инструмент команды — вырос в отдельный клиентский продукт. Поддерживает YouTube, VK Видео, Дзен, RuTube, Instagram, TikTok, Яндекс Диск и файлы до 2 ГБ.",
