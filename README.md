...
| [Бот управления репутацией](https://t.me/sellershelp_reviews_bot) | WB и Ozon: двухэтапный AI (стратег + писатель на Claude), брендовые подписи, алерты рейтинга, Excel-аналитика | 🟡 Тестирование |
| VoiceTask | Голосовой планировщик задач с AI-разбором и напоминаниями — переработка под MAX | 🔄 Переработка |
